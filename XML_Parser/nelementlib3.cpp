...
void ClElement::addTag(char *string) {
...
ClElement *ClElement::sucheElement(char *suche, ClElement *element) {
  ClElement *resultat;
...
int ClElement::elementIstErlaubt(char *name) {
...
int ClElement::attributeIstErlaubt(char *name) {
